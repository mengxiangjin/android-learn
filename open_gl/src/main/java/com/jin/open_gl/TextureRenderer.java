...
public class TextureRenderer implements GLSurfaceView.Renderer{
    ...
    public void init() {
        // Create program
        mProgram = com.xiangji.daka.bean.GLToolbox.createProgram(VERTEX_SHADER, FRAGMENT_SHADER);
    ...
    public void renderTexture(int texId) {
        ...
        com.xiangji.daka.bean.GLToolbox.checkGlError("glUseProgram");

        GLES20.glViewport(0, 0, mViewWidth, mViewHeight);
        com.xiangji.daka.bean.GLToolbox.checkGlError("glViewport");
